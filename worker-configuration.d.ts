/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config dist/server/wrangler.json` (hash: e4385395713b5e39aeeaca94dbbaf431)
// Runtime types generated with workerd@1.20260515.1 2026-05-15 nodejs_compat
interface __BaseEnv_Env {
	REVIEW_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
}
